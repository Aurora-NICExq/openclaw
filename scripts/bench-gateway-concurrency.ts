...
async function runGatewaySample(options: {
  ...
  try {
    try {
      ...
      const providerRequests = summarizeProviderRequests(
      ...
      const modelRequestCount =
        providerRequests.warmup.inference +
        providerRequests.setup.inference +
        providerRequests.load.inference +
        providerRequests.afterLoad.inference;
