...
revision, without resolving the secret. **Cancel** preserves the reference;
**Save** waits for the existing Settings write to be acknowledged. Failed writes
retain the draft, and stale revisions require a fresh read. Read-only config
